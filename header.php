...
<head>
	...
	<script>
		...
		function downloadAllZip(){
			let ans="Are you going to download all documents as zip file?";
			if (confirm(ans)==true) {
				location='zipdownload.php';
			}else{
					...
					<ul class="navbar-nav ml-auto">
						...
						if ($authortype == "qam") {
							...
							<ul class='dropdown-menu' aria-labelledby='dropdown03'>
								<li><a class='dropdown-item' href='#' onclick='myFunction()'>Download Idea CSV</a></li>
								<li><a class='dropdown-item' href='#' onclick='downloadAllZip()'>Download Documents Zip</a></li>
							</ul>
						</li>
							";
						}
